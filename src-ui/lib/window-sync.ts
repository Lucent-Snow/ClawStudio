...
const WINDOW_LABELS = ["main"] as const;
const SESSION_EVENT = "clawstudio://sync-session";
const USER_MESSAGE_EVENT = "clawstudio://sync-user-message";
const SETTINGS_EVENT = "clawstudio://sync-settings";
