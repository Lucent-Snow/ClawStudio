    ...
    <div className={styles.wrapper}>
      <div className={styles.composerColumn}>
        ...
        <div className={styles.inputRow}>
          ...
          <div className={`${styles.inputShell} ${isDragActive ? styles.inputShellDragActive : ""}`}>
            <textarea
              ref={ref}
              className={`${styles.input} ${isDragActive ? styles.inputDragActive : ""}`}
              value={text}
